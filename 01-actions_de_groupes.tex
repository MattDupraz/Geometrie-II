...
% Cette definition n'est pas equivalente!!!
% Contre-exemple: E = {a, b, c}, G = {id, (ab)} dans Bij(E)
% Comme pour cet exemple il n'existe pas de domaine fondamental
% avec la 2eme definition, on garde la premiere.
